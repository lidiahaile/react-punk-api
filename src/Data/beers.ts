...
const beers: Beer[] = [
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 69, unit: "celsius" }, duration: 0 }],
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 68, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        {
          name: "Extra Pale - Spring Blend",
          amount: { value: 5.87, unit: "kilograms" },
        },
        { name: "Caramalt", amount: { value: 0.37, unit: "kilograms" } },
  ...
  },
  {
    ...
    brewers_tips:
      "Sorachi Ace is hop best handled with care. Too much and your beer may taste like dill pickle and lemons.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 34,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 9.35, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 1, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.3, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.38, unit: "kilograms" } },
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 25, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist:
        "Fruit in the boil, berries in the fermenter. Limonnik Berries: 2.5, Twist.",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.77, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.63, unit: "kilograms" } },
      ...
      hops: [
        ...
        {
          name: "Citra",
          amount: { value: 112.5, unit: "grams" },
          add: "dry hop",
          attribute: "aroma",
        },
        {
          name: "Mosaic",
          amount: { value: 200, unit: "grams" },
          add: "dry hop",
          attribute: "aroma",
        },
        {
    ...
    brewers_tips:
      "If you can't get hold of Limonnik berries, rose hips make an accessible alternative!",
    contributed_by: "Ali Skinner <AliSkinner>",
  },
  {
    id: 41,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.06, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.31, unit: "kilograms" } },
        { name: "Crystal 120", amount: { value: 0.23, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.94, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Amarillo",
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 63, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 22, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [{ name: "Pale Ale", amount: { value: 5.3, unit: "kilograms" } }],
      hops: [
        {
          name: "Bobek",
          amount: { value: 25, unit: "grams" },
    ...
    brewers_tips:
      "For a fresh and fiery hit, put some ginger into the cold conditioning phase as well.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 52,
  ...
  },
  {
    ...
    brewers_tips:
      "20% specialty malts in this grist can create problems in the run off. Be careful not to pull the bed down onto the plates.",
    contributed_by: "Matt Ball <GeordieMatt>",
  },
  {
    id: 55,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 8.13, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.28, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.56, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Columbus",
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist:
        "Cacao: 25g at FV, Coffee Beans: 37.5g at FV, Oak Chips: 5g at FV, Vanilla Pods: 10 split pods, Liquorice: 5g at FV",
    },
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 9.25, unit: "kilograms" },
        },
        { name: "Wheat", amount: { value: 1.88, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 1.88, unit: "kilograms" } },
        { name: "Smoked Peaty", amount: { value: 0.13, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "First Gold",
          amount: { value: 81.25, unit: "grams" },
          add: "start",
          attribute: "bitter",
        },
        {
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 10, unit: "celsius" } },
      twist:
        "Seabuckthorn: 25g at end, Sea Salt: 20g at middle, Rum: 25ml at end",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.21, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
    ...
    brewers_tips:
      "Keep the fermentation temperature as steady as possible to allow the lager yeast to do its thing.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 64,
    ...
    ingredients: {
      malt: [
        ...
        { name: "Munich", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Dextrose", amount: { value: 0.38, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Saaz",
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist:
        "Cranberry: 25g at end, Jasmine: 25g at end, Muscovado sugar: 300g at start, Oak chips soaked in lowland whisky: 15g at dry hop",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 7.6, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 1.75, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Roasted Barley", amount: { value: 0.5, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale - Tipple", amount: { value: 10, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 1.25, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 3",
          amount: { value: 0.94, unit: "kilograms" },
        },
        { name: "Crystal", amount: { value: 0.94, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 1.56, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        ...
        { name: "Acidulated Malt", amount: { value: 1.88, unit: "kilograms" } },
        { name: "Wheat Malt", amount: { value: 1.25, unit: "kilograms" } },
        { name: "Rye", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Special W", amount: { value: 0.05, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Amarillo",
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 68, unit: "celsius" }, duration: 30 }],
      fermentation: { temp: { value: 18, unit: "celsius" } },
      twist:
        "Lycii Berries: 7.5g at end, Ginseng: 5.625g at end, Guarana: 25g at end, Kolabu: 25g at end, Gingko: 6.25g at end, Matcha Tea: 12.5g at end, Maca Powder: 16.25g at end",
    },
    ingredients: {
      malt: [
        {
          name: "Extra Pale - Spring Blend",
          amount: { value: 4.38, unit: "kilograms" },
        },
        { name: "Wheat", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.31, unit: "kilograms" } },
      ],
    ...
    brewers_tips:
      "Mix the powders into a paste before adding to the wort kettle. This will prevent the powders from balling up and not bringing the full flavour effect.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 76,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 4.82, unit: "kilograms" },
        },
        { name: "Caramalt", amount: { value: 2.5, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.96, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4, unit: "kilograms" } },
    ...
    brewers_tips:
      "High carbonate water will really accent the malt notes to better balance the punchy hops.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 83,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        ...
        { name: "Caramalt", amount: { value: 0.16, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.06, unit: "kilograms" } },
    ...
    brewers_tips:
      "Columbus and Ahtanum hop additions create a perfect blend of resin and lemon character.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 88,
  ...
  },
  {
    ...
    brewers_tips:
      "Another hop to be treated with respect. Too much in the kettle or dry hop will turn the beer into a garlicky disaster.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 90,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 3.85, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Amarillo",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 3.88, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.13, unit: "kilograms" } },
        { name: "Amber", amount: { value: 0.38, unit: "kilograms" } },
      ],
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 14.5, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Mandarina Bavaria",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 3, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 2, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.08, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: "Use Perigold Truffles after fermentation",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5, unit: "kilograms" } },
        { name: "Special W", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Roasted Barley", amount: { value: 0.31, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.31, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Sorachi Ace",
    ...
    brewers_tips:
      "A little truffle goes a long way. Add 5g, leave for a 2 days and add more if needed.",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 3.5, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.44, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.13, unit: "kilograms" } },
        { name: "Acidulated Malt", amount: { value: 0.63, unit: "kilograms" } },
      ],
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 2.5, unit: "kilograms" } },
        { name: "Torrified Wheat", amount: { value: 0.69, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Motueka",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.35, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.48, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.48, unit: "kilograms" },
        },
        { name: "Chocolate", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Munich", amount: { value: 1.92, unit: "kilograms" } },
        {
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist:
        "Fresh mint leaves after fermentation, Grains of Paradise: 6.5g at end, Fresh Limes: 50g at end.",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.63, unit: "kilograms" } },
        { name: "Ginger Root", amount: { value: 0.13, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Citra",
    ...
    brewers_tips:
      "Use more freshly grated ginger in the mash to get a real spicy nature to the beer.",
    contributed_by: "Matt Ball <GeordieMatt>",
  },
  {
    id: 117,
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 15, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Organic Lager", amount: { value: 1.13, unit: "kilograms" } },
        {
          name: "Organic Caramalt",
          amount: { value: 0.28, unit: "kilograms" },
        },
        { name: "Organic Munich", amount: { value: 2.7, unit: "kilograms" } },
        {
          name: "Organic Chocolate",
          amount: { value: 0.23, unit: "kilograms" },
        },
      ],
      hops: [
        {
          name: "Cascade",
          amount: { value: 27.2, unit: "grams" },
          add: "start",
          attribute: "bitter",
        },
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.94, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.44, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.13, unit: "kilograms" },
  ...
  },
  {
    ...
    first_brewed: "02/2012",
    description:
      "With all the rich tropical flavour you'd expect from Australia's Galaxy, this beer backs up a strong citrus aroma and flavour with a mellow undercurrent of passion fruit and mango. Zingy and sweet but not too sweet, Galaxy has a soft and inviting fruity hop character.",
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 67, unit: "celsius" }, duration: 30 }],
      fermentation: { temp: { value: 18, unit: "celsius" } },
      twist: "Coriander powder: 37.5g at end",
    },
    ingredients: {
      malt: [
        {
          name: "Extra Pale - Spring Blend",
          amount: { value: 2.81, unit: "kilograms" },
        },
        { name: "Wheat", amount: { value: 2.81, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.94, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.31, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "Lactose (Milk Sugar): 500g at middle",
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 6.88, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 1, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.5, unit: "kilograms" } },
        {
        ...
        { name: "Chocolate", amount: { value: 1, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Bramling Cross",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 3.75, unit: "kilograms" } },
  ...
  },
  {
    ...
    first_brewed: "02/2012",
    description:
      "Lemon and lime rise to the top of this hoppy brew, with supporting acts of tropical fruit for a very rounded, thoroughly satisfying flavour. Motueka is a hop we've used in loads of recipes; it has enough resin to balance the intense fruity character.",
    ...
    brewers_tips:
      "Be careful with the Motueka additions. It has an intense citrus character that is often tempered by using in conjunction with other hops.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 132,
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "Wasabi Powder: 45g at end, Wasabi Paste: 75g at end",
    },
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 6, unit: "kilograms" },
        },
        { name: "Chocolate", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Crystal", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Black Malt", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Roasted Malt", amount: { value: 0.25, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
  ...
  },
  {
    ...
    first_brewed: "03/2011",
    description:
      "Brewed by Pivovar Group at BrewDog, specifically for thier bars, Pivo in Leeds, Sheffield Tap in Sheffield, and Euston Tap in Euston. It was then lagered for 2 months and dry hopped with citra.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 4.5,
    ibu: 38,
    target_fg: 1008,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.13, unit: "kilograms" } },
      ],
      hops: [
    ...
    brewers_tips:
      "Dry hop three days before you intend to package to get the freshest hop flavour possible.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 136,
  ...
  },
  {
    ...
    brewers_tips:
      "Some serious investment in equipment will be required here to get the beer down to -40°C in order to remove enough water. Steep the final beer with a handful of your favourite American hops for 12 hours before bottling.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 138,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 5.5, unit: "kilograms" } },
        {
          name: "Maris Otter Extra Pale",
    ...
    brewers_tips:
      "Fresh is best with this beer. Use fresh hops in the brew and during dry hop stages. Condition just long enough to let the powerful grassy aroma cut back - and drink.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 140,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.88, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Pioneer",
    ...
    brewers_tips:
      "Ensure to get the dry hops in and out within 3 days to ensure you capture the best of the hop.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 141,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 7.02, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.19, unit: "kilograms" } },
        { name: "Rye", amount: { value: 0.96, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.29, unit: "kilograms" },
        },
        { name: "Cascara", amount: { value: 0.04, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Centennial",
    ...
    brewers_tips:
      "Split the Cascara evenly between the mash and end of boil to really get the most out of it.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 142,
    ...
    method: {
      ...
      fermentation: { temp: { value: 20, unit: "celsius" } },
      twist: "Orange blossom honey: 1kg in FV.",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 2.5, unit: "kilograms" } },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.25, unit: "kilograms" } },
        { name: "Carared", amount: { value: 0.63, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Citra",
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist:
        "Cranberry: 25g at end, Jasmine: 25g at end, Muscovado sugar: 300g at middle, Oak chips: 15g at FV",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 11.25, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 1.75, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Roasted Barley", amount: { value: 0.5, unit: "kilograms" } },
      ],
  ...
  },
  {
    ...
    first_brewed: "03/2015",
    description:
      "Pilot Brew: A twist on an English Bitter style beer, using Sorachi Ace hops throughout making a showcase of the off the dill and lemon character.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 6.3,
    ibu: 130,
    target_fg: 1010,
    ...
    method: {
      ...
      fermentation: { temp: { value: 20, unit: "celsius" } },
      twist:
        "This beer was unfiltered to give it a traditional ale appearance, Indian Coriander: 2.5g at end",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.38, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.16, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.16, unit: "kilograms" } },
        { name: "Munich", amount: { value: 1.25, unit: "kilograms" } },
        { name: "Rye", amount: { value: 0.63, unit: "kilograms" } },
      ],
      hops: [
    ...
    brewers_tips:
      "The touch of rye adds a great touch of spice that plays off the hops really well.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 146,
    ...
    brewers_tips:
      "Nelson is an amazing hop in the correct proportions. Too much and the beer will start to taste like onions and garlic.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 147,
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 22, unit: "celsius" } },
      twist:
        "Add white sugar to the fermentation to keep the yeast fermenting and produce more alcohol",
    },
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 11.25, unit: "kilograms" },
        },
        { name: "Caramalt", amount: { value: 0.31, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.44, unit: "kilograms" } },
    ...
    brewers_tips:
      "Leaving a large amount of hops in contact with the beer for extended periods will create some undesirable off flavours in the beer. If in doubt rack out to another vessel - then add more dry hops. Keep adding sugar until you hit the ABV.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 149,
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 20, unit: "celsius" } },
      twist: "Lactose: 125g at middle, Sour cherries: 187.5g at middle",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 10, unit: "kilograms" } },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 3.75, unit: "kilograms" } },
        { name: "Wheat Malt", amount: { value: 0.42, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Be prepared to give your Saison yeast plenty of time to do its thing. It’s not unheard of for Saison fermentation taking 6-8 weeks.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 152,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.13, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.25, unit: "kilograms" } },
      ],
      hops: [
    ...
    brewers_tips:
      "Dry hop using a muslin bag in order to give you the best chance at getting the signature Kölsch clarity.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 155,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.56, unit: "kilograms" } },
        {
          name: "Dark Crystal 350",
          amount: { value: 0.66, unit: "kilograms" },
        },
        {
          name: "Carafa Special Malt Type 3",
          amount: { value: 0.31, unit: "kilograms" },
        ...
        { name: "Caramalt", amount: { value: 0.31, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.07, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    ...
    tagline:
      'An Extract Taken From "A Treatise on Food and Diet" By Dr Jonathan Pereira, 1843.',
    first_brewed: "02/2015",
    description:
    ...
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 5.25, unit: "kilograms" },
        },
        {
          name: "White Cane Sugar",
          amount: { value: 0.88, unit: "kilograms" },
        },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [{ name: "Pilsner", amount: { value: 3.81, unit: "kilograms" } }],
      hops: [
        {
          name: "Columbus",
          amount: { value: 5, unit: "grams" },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 9.5, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 1, unit: "kilograms" } },
    ...
    brewers_tips:
      "Age the beer in bottle for a few months at cellar temperature to allow the hot alcohol characteristic to diminish.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 166,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.38, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.19, unit: "kilograms" } },
      ],
      hops: [
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 0, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 0, unit: "celsius" } },
      twist:
        "This beer is an odd one in our collection as it is a blend of two recipes that feature elsewhere. These recipes are #123 Everyday Anarchy and #124 Black Jacques. Both Imperial Saisons spent a little under a year in white and red wine barrels respectively. However, while the pair were being tasted to determine their readiness to be released, a fun game of blending turned into a light bulb moment. The beers were blended and laid down once more in our barrel cellar, this time being infused with the heady note of rum. We were so excited about this mystical blend that we ended up using up all the beer that had been lovingly aged. It would have been a travesty for these beers to go unrecognised as the unique individuals they were, so we brewed them again in 2013 to be released as had always been intended. Age the individual beers separately before blending and ageing further on oak chips soaked in rum.",
    },
    ...
    brewers_tips:
      "It can be difficult to get the perfect balance between both beers. Set up several small blends of varying percentages to determine which you prefer.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 170,
  ...
  },
  {
    ...
    brewers_tips:
      'Challenger hops come from English hops farms - try getting hold of some fresh, undried hops and make a "wet hop" beer.',
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 172,
    ...
    ingredients: {
      malt: [
        {
          name: "Propino Pale Malt",
          amount: { value: 4.1, unit: "kilograms" },
        },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "Enigma has a very high alpha acid so be careful not to over do the bittering hops.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 173,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        {
          name: "Pale Ale - Tipple",
          amount: { value: 8.32, unit: "kilograms" },
        },
        { name: "Munich", amount: { value: 1.79, unit: "kilograms" } },
        { name: "Crystal", amount: { value: 1.19, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.59, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 99, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.75, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.32, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.06, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.32, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 1.69, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.38, unit: "kilograms" } },
    ...
    brewers_tips:
      "Wheat and flaked oats can help to add to the body of the beer. This makes up for the lack of alcoholic bite.",
    contributed_by: "Lars Gregori <choas>",
  },
  {
    id: 181,
    name: "Vic Secret",
    tagline: "Single Hop India Pale Ale.",
    first_brewed: "10/2013",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.4, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
  ...
  },
  {
    ...
    ingredients: {
      malt: [{ name: "Caramalt", amount: { value: 3.13, unit: "kilograms" } }],
      hops: [
        {
          name: "Columbus",
          amount: { value: 8.5, unit: "grams" },
    ...
    brewers_tips:
      "In any low ABV fermentation after primary fermentation has finished if the beer smells or tastes like wort, allow it to condition on the yeast for an extra 24 - 48 hours. This can round the profile off well.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 183,
    ...
    first_brewed: "11/2012",
    description:
      "A dry-hopped Session Pilsner. At 4.2% this amber-hued lager packs a malty punch with toasty Munich character and a light caramel sweetness. From here, things take a sharp turn towards the hoppy flavour, with some serious US citrus packed classic hops.",
    image_url: "https://images.punkapi.com/v2/183.png",
    abv: 4.2,
    ibu: 25,
    target_fg: 1012,
    target_og: 1044,
    ...
    srm: 9.5,
    ph: 4.4,
    attenuation_level: 72.7,
    volume: { value: 20, unit: "litres" },
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 70, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 16, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 3.38, unit: "kilograms" },
        },
        { name: "Caramalt", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.63, unit: "kilograms" } },
      ],
    ...
    brewers_tips:
      "Keep the temperature of the fermentation as close to 12C as possible (or below). This allows the yeast to create a crisper and cleaner beer.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 184,
  ...
  },
  {
    ...
    image_url: "https://images.punkapi.com/v2/185.png",
    abv: 32,
    ibu: 1157,
    target_fg: 1028,
    target_og: 1157,
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist:
        "Cranberry: 25g at end, Jasmine: 25g at end, Muscovado sugar: 300g at start, Oak chips: 15g at FV",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 11.25, unit: "kilograms" } },
    ...
    brewers_tips:
      "This level of alcohol can be achieved using a domestic freezer. Use a container with a tap close to the bottom so you can run the un-frozen, concentrated beer from under the ice on top. You may have to do this three or four times.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 186,
  ...
  },
  {
    ...
    image_url: "https://images.punkapi.com/v2/188.png",
    abv: 10,
    ibu: 55,
    target_fg: 1014,
    target_og: 1128,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.5, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.86, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 2, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.86, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.25, unit: "kilograms" },
        },
  ...
  },
  {
    ...
    method: {
      ...
      fermentation: { temp: { value: 17, unit: "celsius" } },
      twist:
        "Lingon Berries: 25g at end, Cloudberries: 25g ate end, Blueberry Concentrate: 62.5g at FV, Sea Buckthorn: 62.5g at FV",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.25, unit: "kilograms" } },
    ...
    brewers_tips:
      "The mixture of berries and hops create a very intense flavour profile, a great brew for using up some spare hops.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 196,
  ...
  },
  {
    ...
    brewers_tips:
      "Some Munich malt in this beer will lift the biscuity backbone, and provide much needed balance to the heavy hitting US hops.",
    contributed_by: "Ali Skinner <AliSkinner>",
  },
  {
    id: 198,
  ...
  },
  {
    id: 199,
    name: "Alice Porter",
    tagline: "Enigmatic Dark Alchemy.",
    ...
    image_url: "https://images.punkapi.com/v2/199.png",
    abv: 5.2,
    ibu: 55,
    target_fg: 1013,
    target_og: 1053,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 2.63, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.88, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.38, unit: "kilograms" } },
        { name: "Special W", amount: { value: 0.31, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.44, unit: "kilograms" },
        },
        { name: "Flaked Oats", amount: { value: 0.38, unit: "kilograms" } },
        { name: "Torrified Wheat", amount: { value: 0.31, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "The Sorachi Ace hop addition at the end of the boil gives the beer a subtle vanilla flavour that helps to lighten the beer.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 200,
    ...
    srm: 17.5,
    ph: 5.2,
    attenuation_level: 82.4,
    volume: { value: 20, unit: "litres" },
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 85 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.75, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.06, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    image_url: "https://images.punkapi.com/v2/201.png",
    abv: 6.7,
    ibu: 70,
    target_fg: 1015,
    target_og: 1066,
    ...
    brewers_tips: "Use the freshest hops for the most impact.",
    contributed_by: "Matt Ball <GeordieMatt>",
  },
  {
    id: 202,
    ...
    ingredients: {
      malt: [
        ...
        { name: "Rye", amount: { value: 0.75, unit: "kilograms" } },
        { name: "Honey", amount: { value: 0.5, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
    ...
    brewers_tips:
      "Be really careful when mashing, as this amount of malts can get tough to sparge! Add honey into the boil, and naga chilli and vanilla in maturation (soak them in some neutral spirit to sanitise).",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 203,
    name: "Bitch Please (w/ 3 Floyds)",
    tagline: "Barley Wine - 3 Floyds Collab.",
    first_brewed: "02/2012",
    description:
      "This limited edition American Barley Wine was brewed in collaboration with 3 Floyds Brewery. This beer had all the warm, boozy and smoky aspects of an Islay Scotch whisky with the sweet malt and devastatingly bitter attributes of a barley wine. Peat smoke features prominently, backed up with a complex fruity hop profile.",
    image_url: "https://images.punkapi.com/v2/203.png",
    abv: 11.5,
    ibu: 50,
    target_fg: 1016,
    target_og: 1104,
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 0 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "Two bars of Highland Toffee at start of boil",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 8.21, unit: "kilograms" } },
        { name: "Pinhead Oats", amount: { value: 0.36, unit: "kilograms" } },
        { name: "Carahell", amount: { value: 0.18, unit: "kilograms" } },
        { name: "CaraAroma", amount: { value: 0.18, unit: "kilograms" } },
        { name: "Roasted Malt", amount: { value: 0.09, unit: "kilograms" } },
        { name: "Peated Malt", amount: { value: 0.09, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Green Bullet",
        ...
        {
          name: "Motueka",
          amount: { value: 35.5, unit: "grams" },
          add: "end",
          attribute: "flavour",
        },
        {
          name: "Pacific Gem",
          amount: { value: 21.5, unit: "grams" },
          add: "end",
          attribute: "flavour",
        },
        {
    ...
    brewers_tips:
      "To add to the smoky nature of this Barley Wine, source some smoked wood or whisky casks to age the beer in.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 204,
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 90 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: "Several dozen brewers!, Toasted oak chips: 75g at FV",
    },
    ingredients: {
      malt: [
        {
          name: "Maris Otter Extra Pale",
          amount: { value: 6.57, unit: "kilograms" },
        },
        { name: "Caramalt", amount: { value: 0.75, unit: "kilograms" } },
        { name: "Crystal 150", amount: { value: 0.32, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.5, unit: "kilograms" },
        },
    ...
    brewers_tips:
      "Get as many Equity Punks involved. You can toast the oak chips yourself in an oven.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 206,
  ...
  },
  {
    ...
    first_brewed: "08/2012",
    description:
      "The International Arms Race was a new type of battle collaboration between hardcore American craft brewery Flying Dog and BrewDog. Both breweries attempted to brew an IPA with absolutely no hops.",
    ...
    method: {
      ...
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist:
        "Juniper Berries: 25g at start, Bay Leaves: 2.75g at start, Rosemary: 7.5g at start, Rosemary: 5g at end, Elderflower: 15g at end, Juniper Berries: 25g at end",
    },
    ingredients: {
      malt: [
        {
    ...
    brewers_tips:
      "Allow the bay leaves to steep in the boil for extra time to extract some bitterness. The bitterness is really important to bring balance to an otherwise sweet beer.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 208,
    name: "Sunshine On Rye - B-Sides",
    tagline: "Hoppy Rye IPA.",
    first_brewed: "02/2015",
    description:
      'A Pilot Brew "Sunshine on Rye" uses loads of spicy malt and coriander to play nice with an inhuman amount of hops!',
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 7.2,
    ibu: 130,
    target_fg: 1010,
    ...
    food_pairing: ["Jerk spiced goat", "Tonkotsu Ramen", "Gingerbread"],
    brewers_tips:
      "Indian coriander accentuates the citrus character from the hops. Use fresh spices to really accentuate this relationship.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 209,
    name: "Stereo Wolf Stout - Prototype Challenge",
    tagline: "Dark Audio Storm.",
    first_brewed: "02/2015",
    description:
      "Roasty, dark and complex, Stereo Wolf is a 5.2% ABV Stout brewed with a cacophony of hop-driven fruit and spice. Dark chocolate stalks alongside the resonating bitterness, through to Stereo Wolf’s lingering dry finish. Balancing roasty malt and new world hops at 5.2% ABV is no mean feat, but Stereo Wolf takes it in its stride.",
    image_url: "https://images.punkapi.com/v2/209.png",
    abv: 5.2,
    ibu: 55,
    target_fg: 1014,
    target_og: 1052,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 2.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Special W", amount: { value: 0.38, unit: "kilograms" } },
        { name: "Roasted Barley", amount: { value: 0.38, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.38, unit: "kilograms" },
        },
    ...
    brewers_tips:
      "Special W is a specialty malt that creates an intense profile of nuts, raisins and caramel. It provides a focal point for the malt base, that the hops can stack against.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 210,
  ...
  },
  {
    ...
    brewers_tips:
      "Don't be scared by the amount of hops. Seriously this beer can handle them.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 213,
  ...
  {
    id: 216,
    name: "Barrel Aged Hinterland",
    tagline: "A Most Beguiling Brew. Aged In Bourbon Casks.",
    first_brewed: "06/2016",
    description:
      "Hinterland is a beer long in the creation, and even longer in the appreciation. On the aroma, deep reverberating roasty bitterness and sweet dark chocolate. Also in evidence, woodsmoke, rich vanilla, mocha and marzipan. When tasting, Hinterland reveals itself as the beer moves from cellar temperature to something warmer, yielding all of the above plus dried fruit, rich ganache and ending on a resoundingly warming  nish redolent of chocolate liqueur or plum brandy. Aged in Bourbon Casks.",
    image_url: "https://images.punkapi.com/v2/216.png",
    abv: 9,
    ibu: 85,
    target_fg: 1025,
    target_og: 1094,
  ...
  {
    id: 217,
    name: "Barrel Aged Albino Squid Assassin",
    tagline: "Red Rye IPA Aged In Rye Whisky Cask.",
    first_brewed: "06/2016",
    description:
      "This tentacled terminator packs a punch - ten punches to be precise. Each hop addition adds to the intense layers of depth in this red rye IPA. Toasty caramel & cinder toffee from crystal malts, cacao richness from intensely roasted malt and the spiciness of rye. Zesty pithiness from Citra and the robust resin of Chinook. This small batch exclusive brew is up-front intensity matched with twisted complexity. Aged in Rye Whisky Casks.",
    image_url: "https://images.punkapi.com/v2/217.png",
    abv: 9.2,
    ibu: 65,
    target_fg: 1012,
    target_og: 1069,
  ...
  },
  {
    ...
    brewers_tips:
      "Oxygen is critical for this strain of yeast so make sure you aerate your wort properly.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 219,
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "100g Oak chips soaked in Mezcal and 1.6kg Agave syrup in FV",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 7.3, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 360, unit: "kilograms" } },
        { name: "Smoked Malt", amount: { value: 535, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Nail your colours to the mother fucking mast – independence or death.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 220,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 1.3, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.12, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.5, unit: "kilograms" } },
  ...
  {
    id: 225,
    name: "Paradox Islay 2.0",
    tagline: "Islay Cask-Aged Imperial Stout.",
    first_brewed: "06/2016",
    description:
    ...
    image_url: "https://images.punkapi.com/v2/225.png",
    abv: 13,
    ibu: 100,
    target_fg: 1112,
    target_og: 1015,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 2.6, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.35, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.8, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.35, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.1, unit: "kilograms" },
        },
        {
          name: "Carafa Special Malt Type 2",
          amount: { value: 0.2, unit: "kilograms" },
  ...
  {
    id: 228,
    name: "Prototype Helles",
    tagline: "Laid-Back Bavarian Classic.",
    first_brewed: "06/2016",
    description:
      "Our spin on one-of the most popular beer styles ever conceived. A celebration of light, bready malt, with toasty hints and soft bitterness.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 4.9,
    ibu: 18,
    target_fg: 1047,
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.8, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    id: 229,
    name: "Rye Hammer",
    tagline: "Our Ruthless IPA with A Spicy Twist.",
    first_brewed: "06/2016",
    description:
      "Rye Hammer is the fourth of our super-charged hyped up hybrids. A bready beery beast. Rye grains and American hops unite in an agricultural superpower. Aroma of roasted malts, rye bread and subtle floral hops. Grapefruit, roasted caramel with malty fruity notes, followed by the bitterest of bitter finishes. Rye Hammer – liquid daily bread.",
    image_url: "https://images.punkapi.com/v2/229.png",
    abv: 7.2,
    ibu: 250,
    target_fg: 1010,
    target_og: 1065,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5, unit: "kilograms" } },
        { name: "Rye", amount: { value: 1, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Centennial",
    ...
    food_pairing: ["Smoked salmon tostada", "Schäufele", "Rye apple cake"],
    brewers_tips:
      "The amount of rye shouldn’t cause a stuck mash, but if you find you are having problems the addition of rice hulls to your mash can help.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 230,
  ...
  },
  {
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "250g mango puree in FV",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.3, unit: "kilograms" } },
        { name: "Cane Sugar", amount: { value: 0.5, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Centennial",
    ...
    brewers_tips:
      "This fermentation is going to be wild. Use a blow off rather than an airlock to cope with the extra activity.",
    contributed_by: "Matt Ball <GeordieMatt>",
  },
  {
    id: 235,
    name: "Mango And Chili Barley Wine",
    tagline: "Spicy Chewy Sweet",
    first_brewed: "2016",
    description:
    ...
    ingredients: {
      malt: [{ name: "Maris Otter", amount: { value: 7, unit: "kilograms" } }],
      hops: [
        {
          name: "Centennial",
          amount: { value: 5, unit: "grams" },
    ...
    brewers_tips:
      "Crack open the chili and add it in a muslin bag so you can take it out when the chilli heat suits you",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 236,
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 4, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.35, unit: "kilograms" } },
      ],
      hops: [
        {
    ...
    food_pairing: ["Chicken Katsu", "Cheese and Ham Omelette", "Pumpkin Pie"],
    brewers_tips:
      "This beer is all about the balance between the malty backbone of the beer and the fresh hop aroma. The fresher the hops the better.",
    contributed_by: "Sam Mason <samjbmason>",
  },
  {
    id: 237,
    ...
    method: {
      ...
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "Following souring steps outlined in Blitz Series recipes",
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 1, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 1, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.75, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Smoked Malt", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 1.63, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.16, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.63, unit: "kilograms" } },
        { name: "Pale Ale", amount: { value: 1.5, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    id: 239,
    name: "#Mashtag 2016",
    tagline: "Sour cherry triple IPA.",
    first_brewed: "2016",
    description:
    ...
    srm: 8,
    ph: 4.4,
    attenuation_level: 89.04,
    volume: { value: 20, unit: "litres" },
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "250g Sour Cherries, 5g Oak Chips",
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 6.3, unit: "kilograms" } },
        { name: "Dextrose", amount: { value: 1, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Columbus",
    ...
    brewers_tips:
      "Rope in as many friends as you can to make it a truly democratic brew.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 240,
  ...
  {
    id: 241,
    name: "Hello My Name Is Ingrid 2016",
    tagline: "Cloudberry Double IPA",
    first_brewed: "2016",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.9, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.7, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Columbus",
          amount: { value: 8, unit: "grams" },
          add: "Start",
          attribute: "Bitter",
        },
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        ...
        { name: "Munich", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Crystal", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Carahell", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.5, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    id: 244,
    name: "AB:21",
    tagline: "Liquorice Blackcurrant Stout.",
    first_brewed: "2016",
    description:
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: "Liquorice and 200g Blackcurrant Concentrate FV.",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 7.2, unit: "kilograms" } },
        { name: "Brown", amount: { value: 1, unit: "kilograms" } },
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 5, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.53, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.27, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Apollo",
          amount: { value: 26.67, unit: "grams" },
          add: "Start",
          attribute: "Bitter",
        },
        {
          name: "Centennial",
          amount: { value: 13.33, unit: "grams" },
          add: "Middle",
          attribute: "Flavour",
        },
        {
        ...
        {
          name: "Simcoe",
          amount: { value: 1.33, unit: "grams" },
          add: "Dry Hop",
          attribute: "Aroma",
        },
        {
          name: "Apollo",
          amount: { value: 0.67, unit: "grams" },
          add: "Dry Hop",
          attribute: "Aroma",
        },
      ],
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 2.6, unit: "kilograms" } },
        { name: "Simpsons Rye", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.15, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Equinox",
    ...
    food_pairing: ["Crab Cakes", "Spicy Bean Burrito", "Dundee Fruit Cake"],
    brewers_tips:
  ...
  {
    id: 247,
    name: "Self Assembly Pope",
    tagline: "Coconut Vanilla Porter",
    first_brewed: "2016",
    description:
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: "Toasted Coconut Chips – 40g FV & Vanilla Extract – FV",
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.6, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Dextrin Malt", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.35, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.3, unit: "kilograms" },
        },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    first_brewed: "2016",
    description:
      "Brewed in collaboration with our AGM-headlining band, Twin Atlantic, this US style pale features some of our favourite hops and is loaded with tropical fruit.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 5,
    ibu: 80,
    target_fg: 1011,
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: "Mango and Pineapple added to FV after Primary fermentation",
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    id: 249,
    name: "Hop Shot",
    tagline: "Quadruple India Pale Ale",
    first_brewed: "2016",
    description:
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 4, unit: "kilograms" } },
        { name: "Rye", amount: { value: 0.8, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Centennial",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 2, unit: "kilograms" } },
        { name: "Crisp Rye", amount: { value: 0.22, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.11, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.17, unit: "kilograms" } },
        { name: "Acidulated Malt", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Sorachi Ace",
          amount: { value: 22, unit: "grams" },
          add: "Start",
          attribute: "Bitter",
        },
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 5.16, unit: "kilograms" } },
        { name: "Pale Ale", amount: { value: 1.72, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  {
    id: 253,
    name: "Small Batch: 90 Shilling",
    tagline: "Honeyed Spicy Malt.",
    first_brewed: "2017",
    description:
      "A malt-forward Scotch ale with a complex but mellow mix of toast crust, caramel, hints of cocoa, and a light hop spiciness.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 5.3,
    ibu: 25,
    target_fg: 1010,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 54, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        {
          name: "Propino Pale Malt",
          amount: { value: 5.6, unit: "kilograms" },
        },
        {
          name: "Premium English Caramalt",
          amount: { value: 0.6, unit: "kilograms" },
        },
        { name: "Munich", amount: { value: 0.6, unit: "kilograms" } },
        { name: "Amber", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.2, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Bramling Cross",
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 56, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 10, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        {
          name: "Propino Pale Malt",
          amount: { value: 1.2, unit: "kilograms" },
        },
        { name: "Pilsner", amount: { value: 1.35, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Amber", amount: { value: 0.1, unit: "kilograms" } },
      ],
      hops: [
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 7.4, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 1, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  {
    id: 256,
    name: "Small Batch: Vermont IPA",
    tagline: "Juicy, Tropical, Citrusy.",
    first_brewed: "2017",
    description:
      "A vermont style IPA, with low background bitterness, loaded with intense juicy fruit character.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 6.9,
    ibu: 35,
    target_fg: 1012,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.3, unit: "kilograms" } },
        { name: "Maris Otter", amount: { value: 0.8, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
    ...
    brewers_tips:
      "Add the dry hops in separate muslin bags to increase surface area contact and reduce the amount of hop matter in the beer after dry hopping without reducing the characteristic hazy look of the beer.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 257,
    name: "Semi Skimmed Occultist",
    tagline: "Oatmeal Milk Stout.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 7.8, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 1, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.8, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.4, unit: "kilograms" },
        },
        { name: "Wheat", amount: { value: 0.4, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.4, unit: "kilograms" },
        },
        { name: "Chocolate", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    id: 258,
    name: "Paradox Rye",
    tagline: "Rye Whisky Barrel-Aged Imperial Stout.",
    first_brewed: "2005",
    description:
      "In 2006 James and Martin hijacked a beer dinner run by Michael Jackson, the acclaimed beer and whisky writer, and convinced him to taste one of their home brews. This was a defining moment in BrewDog prehistory, and that beer was the first incarnation of the ubiquitous Paradox. Aged in a variety of casks over the years, Paradox is dark, decadent and encapsulating. Can be enjoyed fresh; phenomenal when aged.",
    image_url:"",
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 75 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: "Age this beer in Rye Whisky Casks.",
    },
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 6.5, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.875, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 2, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.875, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.25, unit: "kilograms" },
        },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        {
          name: "Propino Pale Malt",
          amount: { value: 3.8, unit: "kilograms" },
        },
        { name: "Medium Crystal", amount: { value: 0.3, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.05, unit: "kilograms" },
        },
        {
          name: "Premium English Caramalt",
          amount: { value: 0.3, unit: "kilograms" },
        },
        { name: "Brown", amount: { value: 0.5, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "If you are feeling adventurous, and haven’t guzzled your whole batch upon first tasting it, try mulling this like you would a wine or cider. Cinnamon and clove will really lend themselves to the flavour of Tropic Thunder and mulled beer is definitely cooler than the usual offerings at a winter gathering.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 260,
    ...
    ingredients: {
      malt: [
        {
          name: "Propino Pale Malt",
          amount: { value: 3.4, unit: "kilograms" },
        },
        { name: "Torrified Wheat", amount: { value: 0.39, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.56, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Mosaic",
          amount: { value: 33, unit: "grams" },
          add: "Whirlpool",
          attribute: "Aroma",
        },
        {
          name: "Citra",
          amount: { value: 83, unit: "grams" },
          add: "Dry Hop",
          attribute: "Aroma",
        },
        {
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 4.38, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.62, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.62, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.25, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.25, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.19, unit: "kilograms" },
    ...
    brewers_tips:
      "* Not a suitable replacement for an actual breakfast. Nitroing at home is, well, not impossible but unlikely. Luckily this beer tastes great when lightly carbonated too! Be prepared for a slow runoff and don’t skimp on the cacao!",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 262,
    name: "Small Batch: Vermont IPA V2.0",
    tagline: "Juicy, Citrusy, Tropical.",
    first_brewed: "2017",
    description:
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 35 }],
      fermentation: { temp: { value: 10, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.096, unit: "kilograms" } },
        { name: "Pale Ale", amount: { value: 1.032, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    ...
    tagline: "Session Vermont IPA.",
    first_brewed: "2017",
    description:
      "East Coast Crush is a Vermont style pale ale, packaged and served using our custom LIVE beer dispense. A session Vermont IPA, with low background bitterness, loaded with intense juicy mango, pineapple, peach and pine.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 4.8,
    ibu: 25,
    target_fg: 1010,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 30 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.24, unit: "kilograms" } },
        { name: "Uncrushed Wheat", amount: { value: 0.6, unit: "kilograms" } },
    ...
    brewers_tips:
      "Vermont Yeast, whilst desirable for this style of beer, is not absolutely necessary. The murk of a NEIPA can be achieved by malt selection and your process.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 265,
    name: "Pump Action Poet",
    tagline: "Stone Fruit IPA.",
    first_brewed: "2017",
    description:
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 40 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.86, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.54, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.54, unit: "kilograms" } },
      ],
      hops: [
        {
    ...
    food_pairing: ["Citrus Salad", "Spicy Chilli Prawns", "Orange Zest Tart"],
    brewers_tips:
      "Adding the fruit at the end of the boil effectively pasteurises it. If you plan to add fruit after primary fermentation, buy aseptic puree or have a plan to pasteurise it before adding it.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 266,
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 4.533, unit: "kilograms" } },
        { name: "Dextrin Malt", amount: { value: 0.567, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.567, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Amarillo",
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 8.16, unit: "kilograms" } },
        {
          name: "Golden Naked Oats",
          amount: { value: 0.96, unit: "kilograms" },
        },
        { name: "Medium Crystal", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.24, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 3",
          amount: { value: 0.12, unit: "kilograms" },
        },
      ...
      hops: [
        ...
        {
          name: "American Oak Chips Medium Toast Soaked In Speyside Whisky",
          amount: { value: 4, unit: "grams" },
          add: "Flame Out",
          attribute: "Flavour",
        },
    ...
    brewers_tips:
      "Soak American oak (medium toasted) chips in your favourite Speyside tipple overnight and add them after primary fermentation",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 268,
  ...
  },
  {
    ...
    tagline: "Dry-Hopped Wheat Beer.",
    first_brewed: "2017",
    description:
      "An amplified version of a style we first brewed with Weihenstephan. A full-on deluge of spice and citrus, the new world hops bring spiced orange, lemon peel and fresh grassy and floral notes while the weizen base adds pepper, clove and banana.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 7.5,
    ibu: 25,
    target_fg: 1010,
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 3.74, unit: "kilograms" } },
        { name: "White Wheat", amount: { value: 2.267, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.091, unit: "kilograms" },
        },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "A German style wheat beer that is mostly defined by its yeast character. Yeast strain has a massive influence on the final perception of the beer.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 270,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 30 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 5.3, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.8, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.8, unit: "kilograms" } },
        { name: "Smoked Malt", amount: { value: 0.2, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    food_pairing: ["Duck Crackling", "Coq Au Vin", "Oreo Cheesecake"],
    brewers_tips:
      "An oxymoron of a beer. The cocoa nibs are vital in providing that stout like flavour without the associated colour.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 271,
    ...
    brewers_tips:
      "Add heather honey to your boil to make this beer even better!!!",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 272,
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 1.7, unit: "kilograms" } },
        { name: "Spelt", amount: { value: 1.133, unit: "kilograms" } },
        { name: "White Wheat", amount: { value: 0.567, unit: "kilograms" } },
        { name: "Pilsner", amount: { value: 0.567, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Spelt malt can slow your run off, similar to Rye. Take your time or add some extra malt to compensate for lower efficiency.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 273,
    name: "Prototype Double IPA",
    tagline: "American Hop Overload.",
    first_brewed: "2017",
    description:
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 65 }],
      fermentation: { temp: { value: 18, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.92, unit: "kilograms" } },
        { name: "Maris Otter", amount: { value: 0.72, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
    ...
    brewers_tips:
      "The hopping rate should leave a light residual haze in your beer after maturation. Don’t worry, this comes from the hop compounds, haze is taste.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 274,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.08, unit: "kilograms" } },
    ...
    brewers_tips:
      "If you want the colour but less of the flavour of the dark malts, try substituting the Carafa Special III for a dehusked version of Carafa.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 275,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 60, unit: "celsius" }, duration: 80 }],
      fermentation: { temp: { value: 20, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.627, unit: "kilograms" } },
        {
          name: "Torrified Wheat",
          amount: { value: 0.567, unit: "kilograms" },
        },
        {
          ...
          amount: { value: 0.283, unit: "kilograms" },
        },
        { name: "Rye", amount: { value: 0.136, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.136, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Play around with the citrus flavour by using differing amounts of lemon peel, orange peel, grapefruit peel, lime peel or kaffir lime leaves.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 276,
    name: "Nine To Five Wizard",
    ...
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 30 }],
      fermentation: { temp: { value: 24, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.6, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 2.34, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.12, unit: "kilograms" },
        },
    ...
    brewers_tips:
      "If you want more phenolic (Banana & Spice) flavours, ferment at a higher temperature. If you want more fruit esters, keep the fermentation lower and under control.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 277,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 67, unit: "celsius" }, duration: 60 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.3, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.3, unit: "kilograms" } },
    ...
    food_pairing: ["Salmon Salad", "Montery Jack Cheese", "Mandarin Cake"],
    brewers_tips:
      "This yeast strain produces a marked sulphurous note in the beer. If that’s not your thing, don’t Burtonise your mash and see the difference!",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 278,
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 9.6, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Amber", amount: { value: 0.24, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.24, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.24, unit: "kilograms" },
        },
      ],
      hops: [
        {
        ...
        {
          name: "American Oak Chips Medium Toast Soaked in Bourbon",
          amount: { value: 50, unit: "grams" },
          add: "Wood Ageing",
          attribute: "Flavour",
        },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.42, unit: "kilograms" } },
        { name: "Rye", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.18, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 3",
          amount: { value: 0.12, unit: "kilograms" },
        },
    ...
    brewers_tips:
      "Rye can cause run off problems. Try to reach a temperature of 78 degrees Celsius if possible, and sparge at the same temperature.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 280,
    ...
    srm: 5,
    ph: 4.6,
    attenuation_level: 94,
    volume: { value: 20, unit: "litres" },
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 60 }],
      fermentation: { temp: { value: 23, unit: "celsius" } },
      twist: "10kg of glacier water added to the mash.",
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.72, unit: "kilograms" } },
        { name: "Dextrose", amount: { value: 0.84, unit: "kilograms" } },
        { name: "White Wheat", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Torrified Wheat", amount: { value: 0.24, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Amarillo",
    ...
    food_pairing: ["Oysters With a Chilli And Dill Sauce", "Raspberry Souffle"],
    brewers_tips:
      "So your homebrew shop of choice may not stock all the ingredients here! You can buy cloudberry jam and add that instead. The pectin in the jam is not ideal and will form a haze but that can be forgiven in a saison.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 281,
    name: "Homicidal Puppet Help Desk",
    tagline: "Barrel-Aged Rye Barley Wine.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 8.16, unit: "kilograms" } },
        { name: "Rye", amount: { value: 1.44, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.12, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Be careful with brown malt. If you put too much in, it can very easily turn a fantastic tasting beer into a beer that tastes like someone has poured a pint into an ash tray, swirled it around and put it back into your pint.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 282,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 60, unit: "celsius" }, duration: 60 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        ...
        {
          name: "Acidulated Malt",
          amount: { value: 0.287, unit: "kilograms" },
        },
        { name: "Rye", amount: { value: 0.136, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.287, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    id: 283,
    name: "AB:24",
    tagline: "Coffee & Brown Sugar Baltic Porter.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 6.48, unit: "kilograms" } },
        { name: "Munich", amount: { value: 1.44, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.72, unit: "kilograms" },
        },
        { name: "Chocolate Wheat", amount: { value: 0.72, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.72, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Oat Husks", amount: { value: 0.048, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Do not substitute the muscovado sugar with white sugar. It lacks the molasses (black treacle) component that comes from only being partially refined.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 284,
    name: "Hello My Name Is Helga",
    tagline: "Cherry Double IPA.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 5.52, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.12, unit: "kilograms" } },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "Morello Cherries are the go to cherry variety for this beer (and Krieks), the sour compliments the residual sweetness of the malt. Works well if you reduce your IBU to the 20 to 30 range too.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 285,
    name: "Hello My Name Is Sari",
    tagline: "Bilberry Double IPA.",
    first_brewed: "2017",
    description:
    ...
    brewers_tips:
      "Instead of adding the blueberry juice in the kettle. Add fresh blueberries to your secondary fermenter, pitch The Yeast Bay's Melange Sour Blend and wait for 1 year.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 286,
    name: "Hello My Name Is Aune",
    tagline: "Stawberry Double IPA.",
    first_brewed: "2017",
    description:
    ...
    brewers_tips:
      "Strawberry is a very delicate flavour, so don’t shy away with putting a lot more in when you dry hop.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 287,
    ...
    brewers_tips:
      "Save yourself a lot of hassle and buy the blackcurrant as a concentrate or cordial. Ribena time!",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 288,
    ...
    food_pairing: ["Pork meatballs", "Game pie", "Grilled goat’s cheese"],
    brewers_tips:
      "Add the lingonberry juice either to the end of the boil or to the fermenter, depending on whether the juice has been pasteurised.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 289,
    ...
    brewers_tips:
      "The Seville Orange is a bitter orange, so adjust your bittering hop addition down to account for the fact that there will be a contribution from them.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 290,
    name: "Hello My Name Is Niamh",
    tagline: "Elderflower Infused Double IPA.",
    first_brewed: "2017",
    description:
    ...
    brewers_tips:
      "Save yourself a lot of hassle and buy the Elderflower as a concentrate or cordial. Collecting elderberries ranks low on the FPES (fruit picking enjoyment scale), can't imagine the flower picking is much better.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 291,
    name: "Hello My Name Is Sofia",
    tagline: "Lemon Infused Double IPA.",
    first_brewed: "2017",
    description:
    ...
    brewers_tips:
      "Keep an eye on your pH as you are adding your lemon juice. Yeast can tolerate low pH conditions but the length of fermentation may take longer than normal.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 292,
    name: "Hello My Name Is Maria",
    tagline: "Mandarin Infused Double IPA.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      ...
      hops: [
        ...
        {
          name: "Mandarin Segements",
          amount: { value: 1000, unit: "grams" },
          add: "Mash",
          attribute: "Flavour",
        },
      ],
    ...
    brewers_tips:
      "Using the mandarin in the mash means you can also throw in the peel to extract the essential oils from it. The pith can be quite bitter if it makes it into the boil.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 293,
    name: "I Wanna Be Your Dog",
    tagline: "Omnipollo X BrewDog - Barrel Aged Imperial Stout.",
    first_brewed: "2017",
    description:
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 5.76, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 1.2, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 1.08, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.72, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.48, unit: "kilograms" },
        },
        { name: "Brown", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Dextrin Malt", amount: { value: 0.48, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.24, unit: "kilograms" },
        },
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 20 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
    ...
    food_pairing: ["Steak", "Chicken korma", "Lobster salad"],
    brewers_tips:
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 5.169, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.738, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.738, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.738, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.554, unit: "kilograms" } },
        {
          name: "Chocolate Wheat",
          amount: { value: 0.369, unit: "kilograms" },
        },
        {
          name: "Carafa Special Malt Type 1",
          amount: { value: 0.369, unit: "kilograms" },
      ...
      hops: [
        ...
        {
          name: "Cocoa Nibs",
          amount: { value: 15.4, unit: "grams" },
          add: "Flame Out",
          attribute: "Flavour",
        },
        {
          name: "Vanilla Extract",
          amount: { value: 108, unit: "grams" },
          add: "Dry Hop",
          attribute: "Flavour",
        },
        {
    ...
    brewers_tips:
      'Add virgin white oak chips soaked in a Reposado Tequila to give it a "South of the Wall" kick.',
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 296,
    ...
    first_brewed: "2018",
    description:
      "Off-Duty Alien is a citrus IPA, brewed with blood orange and grapefruit to enhance the citurs characteristics of the hops.",
    image_url: "https://images.punkapi.com/v2/keg.png",
    abv: 6.5,
    ibu: 50,
    target_fg: 1010,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 20 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.32, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.84, unit: "kilograms" } },
        { name: "Bitter Orange", amount: { value: 10, unit: "grams" } },
        { name: "Sweet Orange Peel", amount: { value: 10, unit: "grams" } },
        { name: "Grapefruit Peel", amount: { value: 10, unit: "grams" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Adding the orange and grapefruit peels to the mash gently extracts the essential oils from the peel but leaves the bitter pith behind in the spent grain.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 297,
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Extra Pale", amount: { value: 7.44, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 1.44, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 0.72, unit: "kilograms" } },
        { name: "Roasted Barley", amount: { value: 0.72, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Smoked Malt", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Dark Crystal", amount: { value: 0.48, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Nelson Sauvin",
    ...
    brewers_tips:
      "The lactose kettle addition is unfermentable by yeast. Target a pre-boil OG of between 90 and 100, then use the lactose to increase it to the target OG.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 299,
    ...
    ingredients: {
      malt: [
        { name: "Maris Otter", amount: { value: 0.227, unit: "kilograms" } },
        {
          name: "Torrified Wheat",
          amount: { value: 0.227, unit: "kilograms" },
        },
        { name: "Carapils", amount: { value: 0.113, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.113, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
  ...
  },
  {
    id: 300,
    name: "Indie Pale Ale",
    tagline: "True Independent Craft.",
    first_brewed: "2018",
    description:
    ...
    ingredients: {
      malt: [
        ...
        { name: "Wheat", amount: { value: 0.3, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.3, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.3, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
    ...
    brewers_tips:
      "This beer is charactised by the subtle aromas derived from yeast. Ensure you have fresh healthy yeast and good temperature control to replicate these flavours.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 301,
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 60 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 5.28, unit: "kilograms" } },
        { name: "Dextrose", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.12, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
          amount: { value: 16, unit: "grams" },
          add: "90",
          attribute: "Bittering",
        },
        {
    ...
    brewers_tips:
      "This beer is very hop centric. Use the youngest hops that are available and store them in a freezer. This will help slow the degradation of desirable hop compounds.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 306,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 100 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 8.4, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 1.2, unit: "kilograms" } },
        { name: "Flaked Oats", amount: { value: 0.96, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.72, unit: "kilograms" } },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.48, unit: "kilograms" },
        },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.36, unit: "kilograms" },
        },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "Waxing the bottle/cap helps to exclude oxygen ingress through the cap if you are looking to cellar the beer for a long time.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 307,
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 4.68, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.84, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.3, unit: "kilograms" },
        ...
        { name: "Chocolate Wheat", amount: { value: 0.18, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Try experimenting with fenugreek seeds which give off a maple syrup like flavour.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 308,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 40 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 7.38, unit: "kilograms" } },
        {
          name: "Weyermann Special III",
          amount: { value: 1.2, unit: "kilograms" },
        },
        { name: "Flaked Oats", amount: { value: 0.462, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Chinook",
    ...
    brewers_tips:
      "Its probably best to parti-gyle this beer as this will have a run off time of 6 hours+!!! Set up the mash and see what is collected overnight, then add more hot water to do your second mash and make a low (3%) beer from your residual extract.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 309,
    ...
    brewers_tips:
      "Brew this as part of a parti gyle mash, making this beer from your first runnings. It will take a long time to run off and be prepared to add dextrose to reach your target OG.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 310,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 66, unit: "celsius" }, duration: 45 }],
      fermentation: { temp: { value: 19, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 3.42, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.432, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.09, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Simcoe",
    ...
    brewers_tips:
      "Try your own fruit series with this beer. Grapefruit, Passionfruit, Rapberries or Morello Cherries would be great.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 311,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 55 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.38, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.36, unit: "kilograms" } },
        { name: "Carapils", amount: { value: 0.24, unit: "kilograms" } },
      ],
      hops: [
    ...
    brewers_tips:
      "This IPA features German hops in the dry hop. Why not try a Slovenian only version using: Dana, Bobek, Aurora & Cascade.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 312,
    ...
    brewers_tips:
      "Age this beer!!! Often it will pick up new incredible flavours after an extended cellaring. Think 2 years plus.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 313,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 64, unit: "celsius" }, duration: 135 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 5.88, unit: "kilograms" } },
        { name: "Chocolate", amount: { value: 1.68, unit: "kilograms" } },
        { name: "Munich", amount: { value: 0.96, unit: "kilograms" } },
        { name: "Wheat", amount: { value: 0.96, unit: "kilograms" } },
        { name: "Brown", amount: { value: 0.6, unit: "kilograms" } },
        { name: "Black Malt", amount: { value: 0.48, unit: "kilograms" } },
        {
          name: "Extra Dark Crystal",
          amount: { value: 0.24, unit: "kilograms" },
        },
    ...
    food_pairing: ["Affogato with ice cream", "Chocolate cake"],
    brewers_tips:
      "If your mash run off takes a long time, increase the temperature of your sparge water to keep the mash bed warm and permeable.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 314,
    ...
    brewers_tips:
      "Add the mango puree towards the end of primary fermentation, about 10 SG points above your FG. Allow it to reach FG and have a diacetyl rest before dry hopping it.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 315,
    ...
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 4.32, unit: "kilograms" } },
        {
          name: "Munich Type 1 Light",
          amount: { value: 0.6, unit: "kilograms" },
        },
        {
          name: "Double Roasted Crystal",
          amount: { value: 0.42, unit: "kilograms" },
        },
        { name: "Chocolate Wheat", amount: { value: 0.3, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.24, unit: "kilograms" } },
        {
          name: "Carafa Special Malt Type 3",
          amount: { value: 0.18, unit: "kilograms" },
        },
  ...
  },
  {
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 4.2, unit: "kilograms" } },
        {
          name: "Munich Type 1 Light",
          amount: { value: 0.96, unit: "kilograms" },
        },
        { name: "Carapils", amount: { value: 0.06, unit: "kilograms" } },
        { name: "Acidulated Malt", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
    ...
    brewers_tips:
      "Traditional German brewing is awesome and deserving of respect. If you brew this during spring time, call it a Maibock, any other time of the year and it should be called an Helles Bock.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 317,
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 65, unit: "celsius" }, duration: 35 }],
      fermentation: { temp: { value: 21, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pale Ale", amount: { value: 7.08, unit: "kilograms" } },
        { name: "Caramalt", amount: { value: 0.48, unit: "kilograms" } },
        { name: "Light Crystal", amount: { value: 0.24, unit: "kilograms" } },
        { name: "Medium Crystal", amount: { value: 0.12, unit: "kilograms" } },
        { name: "Sweet Orange Peel", amount: { value: 20, unit: "grams" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    food_pairing: ["Stilton and walnut salad", "Toffee caramel cheesecake"],
    brewers_tips:
      "Sanitise the oak chips before adding them to the fermenter. Vodka is ideal as it’s a neutral spirit and can be drained off. If you don’t want to affect the ABV, try steaming them.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 318,
    ...
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.6, unit: "kilograms" } },
        { name: "Carapils", amount: { value: 0.36, unit: "kilograms" } },
        { name: "Vienna", amount: { value: 0.24, unit: "kilograms" } },
        { name: "Acidulated Malt", amount: { value: 0.06, unit: "kilograms" } },
      ],
      hops: [
        {
  ...
  },
  {
    ...
    boil_volume: { value: 25, unit: "litres" },
    method: {
      mash_temp: [{ temp: { value: 63, unit: "celsius" }, duration: 60 }],
      fermentation: { temp: { value: 12, unit: "celsius" } },
      twist: 0,
    },
    ingredients: {
      malt: [
        { name: "Pilsner", amount: { value: 3.48, unit: "kilograms" } },
        {
          name: "Munich Type 1 Light",
          amount: { value: 0.96, unit: "kilograms" },
        },
        {
          name: "Grano Dei Miracoli",
          amount: { value: 0.24, unit: "kilograms" },
        },
        { name: "Brown", amount: { value: 0.18, unit: "kilograms" } },
        { name: "Chocolate Wheat", amount: { value: 0.12, unit: "kilograms" } },
      ],
      hops: [
        {
          name: "Magnum",
    ...
    brewers_tips:
      "Grano dei Miracoli is a unique ancient grain and shouldn't be substituted, this beer is focused on what this ingredient offers when paired with modern malts.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
  {
    id: 320,
    name: "King of Eights",
    tagline: "East Coast IPA",
    first_brewed: "2018",
    description:
    ...
    food_pairing: ["Grilled lemon sole", "Fish tacos", "Crème brûlée"],
    brewers_tips:
      "Pectin powder can easily be sourced and is an easy alternative for a homebrewer to produce murky beer if you don’t have access to a low flocculating yeast.",
    contributed_by: "John Jenkman <johnjenkman>",
  },
